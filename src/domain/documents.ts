...
export interface DocType {
  ...
  list: () => { id: string; label: string; sublabel?: string; status?: string }[];
}
...
export const DOC_TYPES: DocType[] = [
  ...
  },
  {
    ...
    list: () => all<any>(`SELECT id, sku, description FROM products ORDER BY sku`)
  ...
  },
  {
    ...
    list: () => all<any>(`SELECT id, status FROM pallets ORDER BY id`)
